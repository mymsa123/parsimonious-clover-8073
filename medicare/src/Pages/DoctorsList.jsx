          ...
          <Flex gap={10}>
            <div>
              <input
                ...
                checked={category.includes("General Physician")}
              />
            ...
            <div>
              <input
                ...
                value={"Cardiologist"}
                onChange={handleCategory}
                checked={category.includes("Cardiologist")}
              />
            ...
            <div>
              <input
                ...
                value={"Dermatologist"}
                onChange={handleCategory}
                checked={category.includes("Dermatologist")}
              />
            ...
            <div>
              <input
                ...
                onChange={handleCategory}
                checked={category.includes("Physiotherapist")}
              />
